...
pub enum ibv_event_type {
    ...
    IBV_EVENT_DEVICE_SPEED_CHANGE = 20,
}
#[repr(C)]
#[derive(Copy, Clone)]
...
pub struct verbs_context {
    pub dm_export_dmabuf_fd:
        ::std::option::Option<unsafe extern "C" fn(dm: *mut ibv_dm) -> ::std::os::raw::c_int>,
    pub reg_mr_ex: ::std::option::Option<
        unsafe extern "C" fn(pd: *mut ibv_pd, mr_init_attr: *mut ibv_mr_init_attr) -> *mut ibv_mr,
    >,
    pub dealloc_dmah:
        ::std::option::Option<unsafe extern "C" fn(dmah: *mut ibv_dmah) -> ::std::os::raw::c_int>,
    pub alloc_dmah: ::std::option::Option<
        unsafe extern "C" fn(
            context: *mut ibv_context,
...
const _: () = {
    ...
    ["Offset of field: verbs_context::reg_mr_ex"]
        [::std::mem::offset_of!(verbs_context, reg_mr_ex) - 8usize];
    ["Offset of field: verbs_context::dealloc_dmah"]
        [::std::mem::offset_of!(verbs_context, dealloc_dmah) - 16usize];
    ["Offset of field: verbs_context::alloc_dmah"]
        [::std::mem::offset_of!(verbs_context, alloc_dmah) - 24usize];
    ["Offset of field: verbs_context::query_port"]
        [::std::mem::offset_of!(verbs_context, query_port) - 32usize];
    ["Offset of field: verbs_context::advise_mr"]
        [::std::mem::offset_of!(verbs_context, advise_mr) - 40usize];
    ["Offset of field: verbs_context::alloc_null_mr"]
        [::std::mem::offset_of!(verbs_context, alloc_null_mr) - 48usize];
    ["Offset of field: verbs_context::read_counters"]
        [::std::mem::offset_of!(verbs_context, read_counters) - 56usize];
    ["Offset of field: verbs_context::attach_counters_point_flow"]
        [::std::mem::offset_of!(verbs_context, attach_counters_point_flow) - 64usize];
    ["Offset of field: verbs_context::create_counters"]
        [::std::mem::offset_of!(verbs_context, create_counters) - 72usize];
    ["Offset of field: verbs_context::destroy_counters"]
        [::std::mem::offset_of!(verbs_context, destroy_counters) - 80usize];
    ["Offset of field: verbs_context::reg_dm_mr"]
        [::std::mem::offset_of!(verbs_context, reg_dm_mr) - 88usize];
    ["Offset of field: verbs_context::alloc_dm"]
        [::std::mem::offset_of!(verbs_context, alloc_dm) - 96usize];
    ["Offset of field: verbs_context::free_dm"]
        [::std::mem::offset_of!(verbs_context, free_dm) - 104usize];
    ["Offset of field: verbs_context::modify_flow_action_esp"]
        [::std::mem::offset_of!(verbs_context, modify_flow_action_esp) - 112usize];
    ["Offset of field: verbs_context::destroy_flow_action"]
        [::std::mem::offset_of!(verbs_context, destroy_flow_action) - 120usize];
    ["Offset of field: verbs_context::create_flow_action_esp"]
        [::std::mem::offset_of!(verbs_context, create_flow_action_esp) - 128usize];
    ["Offset of field: verbs_context::modify_qp_rate_limit"]
        [::std::mem::offset_of!(verbs_context, modify_qp_rate_limit) - 136usize];
    ["Offset of field: verbs_context::alloc_parent_domain"]
        [::std::mem::offset_of!(verbs_context, alloc_parent_domain) - 144usize];
    ["Offset of field: verbs_context::dealloc_td"]
        [::std::mem::offset_of!(verbs_context, dealloc_td) - 152usize];
    ["Offset of field: verbs_context::alloc_td"]
        [::std::mem::offset_of!(verbs_context, alloc_td) - 160usize];
    ["Offset of field: verbs_context::modify_cq"]
        [::std::mem::offset_of!(verbs_context, modify_cq) - 168usize];
    ["Offset of field: verbs_context::post_srq_ops"]
        [::std::mem::offset_of!(verbs_context, post_srq_ops) - 176usize];
    ["Offset of field: verbs_context::destroy_rwq_ind_table"]
        [::std::mem::offset_of!(verbs_context, destroy_rwq_ind_table) - 184usize];
    ["Offset of field: verbs_context::create_rwq_ind_table"]
        [::std::mem::offset_of!(verbs_context, create_rwq_ind_table) - 192usize];
    ["Offset of field: verbs_context::destroy_wq"]
        [::std::mem::offset_of!(verbs_context, destroy_wq) - 200usize];
    ["Offset of field: verbs_context::modify_wq"]
        [::std::mem::offset_of!(verbs_context, modify_wq) - 208usize];
    ["Offset of field: verbs_context::create_wq"]
        [::std::mem::offset_of!(verbs_context, create_wq) - 216usize];
    ["Offset of field: verbs_context::query_rt_values"]
        [::std::mem::offset_of!(verbs_context, query_rt_values) - 224usize];
    ["Offset of field: verbs_context::create_cq_ex"]
        [::std::mem::offset_of!(verbs_context, create_cq_ex) - 232usize];
    ["Offset of field: verbs_context::priv_"]
        [::std::mem::offset_of!(verbs_context, priv_) - 240usize];
    ["Offset of field: verbs_context::query_device_ex"]
        [::std::mem::offset_of!(verbs_context, query_device_ex) - 248usize];
    ["Offset of field: verbs_context::ibv_destroy_flow"]
        [::std::mem::offset_of!(verbs_context, ibv_destroy_flow) - 256usize];
    ["Offset of field: verbs_context::ABI_placeholder2"]
        [::std::mem::offset_of!(verbs_context, ABI_placeholder2) - 264usize];
    ["Offset of field: verbs_context::ibv_create_flow"]
        [::std::mem::offset_of!(verbs_context, ibv_create_flow) - 272usize];
    ["Offset of field: verbs_context::ABI_placeholder1"]
        [::std::mem::offset_of!(verbs_context, ABI_placeholder1) - 280usize];
    ["Offset of field: verbs_context::open_qp"]
        [::std::mem::offset_of!(verbs_context, open_qp) - 288usize];
    ["Offset of field: verbs_context::create_qp_ex"]
        [::std::mem::offset_of!(verbs_context, create_qp_ex) - 296usize];
    ["Offset of field: verbs_context::get_srq_num"]
        [::std::mem::offset_of!(verbs_context, get_srq_num) - 304usize];
    ["Offset of field: verbs_context::create_srq_ex"]
        [::std::mem::offset_of!(verbs_context, create_srq_ex) - 312usize];
    ["Offset of field: verbs_context::open_xrcd"]
        [::std::mem::offset_of!(verbs_context, open_xrcd) - 320usize];
    ["Offset of field: verbs_context::close_xrcd"]
        [::std::mem::offset_of!(verbs_context, close_xrcd) - 328usize];
    ["Offset of field: verbs_context::_ABI_placeholder3"]
        [::std::mem::offset_of!(verbs_context, _ABI_placeholder3) - 336usize];
    ["Offset of field: verbs_context::sz"][::std::mem::offset_of!(verbs_context, sz) - 344usize];
    ["Offset of field: verbs_context::context"]
        [::std::mem::offset_of!(verbs_context, context) - 352usize];
};
...
unsafe extern "C" {
    #[doc = " ibv_query_port_speed - Get port effective speed in 100 Mb/s granularity."]
    pub fn ibv_query_port_speed(
        context: *mut ibv_context,
        port_num: u32,
        port_speed: *mut u64,
    ) -> ::std::os::raw::c_int;
...
unsafe extern "C" {
    pub fn ibv_dm_export_dmabuf_fd(dm: *mut ibv_dm) -> ::std::os::raw::c_int;
}
unsafe extern "C" {
